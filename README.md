...
To run the python scripts used for the simulations in the paper, add the absolute path to the files to Tools/Python/Python Script in MMX. Make sure the directories are in the same structure, so that the scripts can find the correct meshes.
