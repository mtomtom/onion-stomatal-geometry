...
## Set the path to the folder containing the meshes.
path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "Meshes", "Onion meshes anisotropy")) + os.sep
...
for mesh in mesh_names:
    ...
    ## Make sure we have the correct cell complex
    Process.Model__CCF__999_Set_Current_Cell_Complex('combined')
